...
A modern, attractive, and responsive Student Registration System built with Java (Jakarta EE), JSP, and MySQL. Featuring a Glassmorphism UI, real-time analytics with Chart.js, and student management capabilities.
